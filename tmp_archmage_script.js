...
const filePath = path.join('src','data','skills','маг-скіли','Archmage - База знаний Л2.htm');
...
const findReqLevel = (pos)=>{ let req=76; for(const a of anchors){ if(a.pos<=pos) req=a.req; else break; } return req; };
const entries=[];
