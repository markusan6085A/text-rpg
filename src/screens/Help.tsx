        ...
        <div className="space-y-0 max-h-[65vh] overflow-y-auto pb-20">
          <Section title="Гра в розробці — з чого почати (UK)" defaultOpen={true}>
            ...
            <p>
              ...
              <LinkBtn onClick={() => navigate("/gk")}>телепорт (GK)</LinkBtn>, обери зону з мобами → на екрані локації натисни моба, щоб почати бій. Досвід, дроп і здобуте залишаються з персонажем, коли ти знову заходиш під тим самим профілем.
            </p>
            <p>
