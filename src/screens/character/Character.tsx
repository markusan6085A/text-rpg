      ...
      >
        ...
        <div className="w-full px-3 mb-2 mt-1 flex justify-between">
          ...
          <div className="flex flex-col text-left mt-1 flex-1">
            <div className="border-t border-dotted border-[#C9B36B] pt-2 pb-2">
              ...
              <div className="text-[11px] text-yellow-300 mt-1 border-t border-dotted border-[#C9B36B] pt-1">
                Профессия:{" "}
                {(() => {
            ...
            <div className="border-b border-dotted border-[#C9B36B]"></div>
          </div>

          {/* КНОПКИ СПРАВА */}
          <div className="flex flex-col gap-1 text-right text-[10px] ml-2 border-t border-dotted border-[#C9B36B] pt-2 pb-2 border-b border-dotted border-[#C9B36B]">
            <button
        ...
        <div className="w-full border-t border-dotted border-[#C9B36B] mt-2"></div>
        ...
        <div className="w-[330px] text-left text-[12px] text-[#d3d3d3] mt-4 space-y-1">
          ...
          <div className="border-b border-dotted border-[#C9B36B] pb-1 flex items-center gap-2">
          ...
          <button
            ...
            className="mt-2 text-left hover:text-yellow-400 transition-colors cursor-pointer border-b border-dotted border-[#C9B36B] pb-1 w-full text-[#d3d3d3] flex items-center gap-2"
          >
          ...
          <button
            ...
            className="text-left hover:text-yellow-400 transition-colors cursor-pointer border-b border-dotted border-[#C9B36B] pb-1 w-full text-[#d3d3d3] flex items-center gap-2"
          >
            <img src="/icons/news.png" alt="Quests" className="w-3 h-3 object-contain" />
            <span>Мои квесты</span>
          </button>

          <div className="mt-2 border-b border-dotted border-[#C9B36B] pb-1 flex items-center gap-2">
        ...
        {/* Социальный статус */}
        <div className="w-[330px] text-left text-[11px] text-[#d3d3d3] mt-4 border-t border-dotted border-[#C9B36B] pt-3">
