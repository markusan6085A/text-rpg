...
export default function Character({ navigate: navigateProp }: CharacterProps = {}) {
  ...
  const testRowBase =
    "w-full text-left text-[12px] py-2.5 px-3 mb-2 rounded-xl flex items-center gap-2.5 bg-[linear-gradient(180deg,#1e293b_0%,#0f172a_42%,#020617_100%)] border border-cyan-950/50 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),inset_0_-3px_10px_rgba(0,0,0,0.55),0_4px_0_rgba(0,0,0,0.35),0_8px_18px_rgba(0,0,0,0.55)]";
  ...
  const svcBtn = (classes: string) =>
    isGoldL2
      ...
      : isTestProfile
        ? `${testRowBase} hover:border-cyan-800/55 hover:brightness-110 active:translate-y-px active:shadow-[inset_0_3px_10px_rgba(0,0,0,0.35)] transition-[border-color,transform,box-shadow,filter] duration-150 ${classes}`
  ...
  const statAccent = isTestProfile ? "text-cyan-200/85" : "text-[#f0d78c]";
  ...
  const topBtn = isGoldL2
    ...
    : isTestProfile
      ? "w-[76px] h-[26px] rounded-lg border border-cyan-900/55 bg-[linear-gradient(180deg,#334155_0%,#0f172a_50%,#020617_100%)] text-[10px] font-semibold text-cyan-100/95 leading-none shadow-[inset_0_1px_0_rgba(255,255,255,0.11),inset_0_-4px_8px_rgba(0,0,0,0.55),0_4px_0_rgba(0,0,0,0.45)] hover:border-cyan-600/50 hover:brightness-110 active:translate-y-[2px] active:shadow-[inset_0_3px_8px_rgba(0,0,0,0.45)] transition-[border-color,transform,box-shadow,filter] duration-150"
        ...
        <div
          className={
            isGoldL2
              ...
              : isTestProfile
                ? "w-full mb-3 rounded-2xl border border-cyan-950/45 bg-[linear-gradient(180deg,#0c1220_0%,#030712_55%,#000000_100%)] p-3 shadow-[inset_0_1px_0_rgba(94,234,212,0.1),inset_0_-6px_16px_rgba(0,0,0,0.5),0_6px_20px_rgba(0,0,0,0.65)]"
            ...
            <div className="min-w-0">
              <div
                className={
                  isGoldL2
                    ...
                    : isTestProfile
                      ? "text-[15px] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300/95 via-slate-100 to-violet-300/90 leading-tight tracking-wide [filter:drop-shadow(0_2px_4px_rgba(0,0,0,0.85))_drop-shadow(0_0_14px_rgba(34,211,238,0.2))]"
              ...
              {showModernLayout && (
                <p
                  className={
                    isTestProfile
                      ? "text-[11px] text-slate-400 mt-2 leading-snug"
              ...
              {isTestProfile && <div className="h-px bg-gradient-to-r from-transparent via-cyan-700/35 to-transparent mt-2.5 shadow-[0_1px_0_rgba(255,255,255,0.04)]" />}
            </div>
          ...
          <div
            className={
              isGoldL2
                ...
                : isTestProfile
                  ? "border-t border-cyan-950/40 pt-2 pb-1 mt-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]"
                  : "border-t border-solid border-[#c7ad80]/60 pt-2 pb-2 mt-2"
            }
          >
            <div
              className={`text-xs ${isTestProfile ? "text-slate-500" : "text-[#d4c4a8]"}`}
            >
              Статус:{" "}
              {status ? (
                <span className={isTestProfile ? "text-cyan-200/90" : "text-[#f0d78c]"}>
                  {status}
                </span>
              ) : showModernLayout ? (
            ...
            {showModernLayout ? (
              <div
                className={
                  isTestProfile
                    ? "mt-2 border-t border-cyan-950/35 pt-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]"
        ...
        <div
          className={
            isGoldL2
              ...
              : isTestProfile
                ? "w-full border-t border-cyan-950/40 mt-2 mb-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]"
        ...
        <div
          className={
            isGoldL2
              ...
              : isTestProfile
                ? "w-full text-left text-[12px] mt-1 text-slate-400"
            ...
            >
              ...
              <div className="pl-6 w-full">
                <div
                  className={
                    isTestProfile
                      ? "h-2 rounded-md overflow-hidden bg-black/80 border border-cyan-950/55 shadow-[inset_0_3px_8px_rgba(0,0,0,0.85),inset_0_1px_0_rgba(94,234,212,0.08)]"
                ...
                >
                  <div
                    className={`h-full ${
                      isTestProfile
                        ? "bg-gradient-to-b from-cyan-500 via-indigo-600 to-violet-950 shadow-[inset_0_1px_0_rgba(255,255,255,0.25),0_1px_0_rgba(0,0,0,0.4)]"
        ...
        <div
          className={
            isGoldL2
              ...
              : isTestProfile
                ? "w-full text-left text-[11px] mt-3 rounded-2xl border border-cyan-950/45 bg-[linear-gradient(180deg,#0c1018_0%,#020617_100%)] p-3 text-slate-400 shadow-[inset_0_1px_0_rgba(94,234,212,0.07),inset_0_-5px_14px_rgba(0,0,0,0.45),0_6px_16px_rgba(0,0,0,0.6)]"
        ...
        >
          <div
            className={
              isGoldL2
                ...
                : isTestProfile
                  ? "font-semibold mb-2 text-[12px] text-cyan-200/90"
                  : "font-semibold mb-2"
            }
          >
            Социальный статус
          ...
          <div
            className={`grid grid-cols-2 gap-x-4 gap-y-1.5 text-[10px] ${
              isTestProfile ? "text-slate-500" : "text-[#d4c4a8]"
            }`}
          >
          ...
          {registrationDate && (
            <div
              className={`mt-2 text-[10px] ${isTestProfile ? "text-slate-600" : "text-[#8a7a60]"}`}
            >
              Рег-я:{" "}
        ...
        <div className="fixed inset-0 bg-black/65 flex items-center justify-center z-50">
          <div
            className={
              isGoldL2
                ...
                : isTestProfile
                  ? "rounded-2xl border border-cyan-950/50 p-4 shadow-[0_20px_50px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(94,234,212,0.08),inset_0_-6px_18px_rgba(0,0,0,0.45)] bg-[linear-gradient(180deg,#0f1624_0%,#020617_55%,#000000_100%)]"
          ...
          >
            <div
              className={
                isGoldL2
                  ...
                  : isTestProfile
                    ? "text-cyan-200/90 font-bold text-sm text-center mb-2 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]"
            ...
            <input
              ...
              className={
                isTestProfile
                  ? "w-full bg-[#020617] text-slate-200 border border-cyan-950/50 focus:border-cyan-700/50 p-1.5 text-sm mb-3 rounded-lg outline-none shadow-[inset_0_2px_8px_rgba(0,0,0,0.65),inset_0_1px_0_rgba(255,255,255,0.05)]"
                  : "w-full bg-black/80 text-[#e8dcc8] border border-[#5c4a32]/70 focus:border-[#c7ad80]/50 p-1.5 text-sm mb-3 rounded outline-none"
              }
