        ...
        <div className="w-full max-w-[360px] border border-[#5b4726] rounded-lg p-4 bg-[#1a0b0b]/30">
          ...
          <div className="space-y-1">
            {conversationLetters.map((letter: any) => {
              ...
              return (
                <div key={letter.id} className="border-b border-dotted border-separator pb-1 mb-1">
    ...
    <div className="w-full flex flex-col items-center text-white px-3 py-4">
      <div className="w-full max-w-[360px] border border-[#5b4726] rounded-lg p-4 bg-[#1a0b0b]/30">
        ...
        {loading && letters.length === 0 ? (
          ...
          <div className="space-y-1">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex items-center justify-between p-2 border-b border-dotted border-separator animate-pulse">
          ...
          <div className="space-y-1">
            {conversations.map((conv) => (
              <div
                ...
                className="flex items-center justify-between p-2 border-b border-dotted border-separator cursor-pointer hover:bg-gray-800/30 transition-colors"
              >
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <span
