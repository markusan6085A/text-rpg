  ...
  return (
    <div className="w-full flex flex-col items-center text-white">
      <div className="w-full max-w-[360px] mt-2 px-3">
        {/* Заголовок */}
        <div className="border-t border-dotted border-[#C9B36B] pt-2 mb-2">
        ...
        <div className="border-t border-dotted border-[#C9B36B] pt-2 mb-2">
          <div className="text-center text-[12px]">
            ...
            <div className="border-b border-dotted border-[#C9B36B] pb-2 mb-2">
        ...
        {character.lastActivityAt && (
          <div className="border-t border-dotted border-[#C9B36B] pt-2 mb-2">
            <div className="text-center text-[11px] border-b border-dotted border-[#C9B36B] pb-2">
              {isOnline ? (
        ...
        {/* Статус */}
        <div className="border-t border-dotted border-[#C9B36B] pt-2 mb-3">
          <div className="text-center text-[11px] text-gray-400 border-b border-dotted border-[#C9B36B] pb-2">
        ...
        <div className="flex flex-col gap-1 mb-4">
          <div className="w-full border-t border-b border-dotted border-[#C9B36B] py-1">
            <span 
        ...
        {(() => {
          ...
          return (
            <div className="mb-4 border-t border-dotted border-[#C9B36B] pt-3">
              <div className="text-[#dec28e] text-sm font-semibold mb-2 border-b border-dotted border-[#C9B36B] pb-1">
        ...
        {/* Інформація */}
        <div className="space-y-2 text-[11px] text-gray-300 border-t border-dotted border-[#C9B36B] pt-3">
          {/* Профессия */}
          ...
          {/* Социальный статус */}
          <div className="border-t border-dotted border-[#C9B36B] pt-2 mt-2">
          ...
          {/* PvP */}
          <div className="border-t border-dotted border-[#C9B36B] pt-2">
