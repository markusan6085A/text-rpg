  ...
  return (
    <div className="min-h-screen h-[100dvh] bg-black flex justify-center p-2 sm:p-4 overflow-hidden">
      ...
      >
        ...
        <div ref={contentRef} className={`flex-1 min-h-0 overflow-y-auto overflow-x-hidden relative z-10 flex justify-center ${contentTopCompact ? "pt-4" : "pt-14"}`} style={{ paddingBottom: "max(18rem, env(safe-area-inset-bottom, 0px) + 14rem)" }}>
