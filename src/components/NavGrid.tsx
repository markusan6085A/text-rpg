...
export default function NavGrid({ navigate }: NavGridProps) {
  ...
  return (
    <div className="fixed bottom-0 z-50 w-full flex justify-center box-border bg-gradient-to-t from-[#0b0806] via-[#0b0806cc] to-transparent pt-2 pb-2 px-1.5 sm:px-2 md:px-3 pointer-events-none left-0 right-0">
