...
export const skill_0056: SkillDefinition = {
  ...
  levels: [
    ...
    { level: 7, requiredLevel: 15, spCost: 1100, mpCost: 34, power: 158 },
    { level: 8, requiredLevel: 15, spCost: 1100, mpCost: 36, power: 172 },
    { level: 9, requiredLevel: 15, spCost: 1100, mpCost: 37, power: 187 },
  ],
};
