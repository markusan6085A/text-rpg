...
export const skill_0171: SkillDefinition = {
  ...
  code: "ES_0171",
  name: "Esprit",
  description: "Increases recovery speed while one is running.\n\nУвеличивает скорость восстановления HP при беге на 2.5 HP/сек.\nУвеличивает скорость восстановления MP при беге на 0.8 MP/сек.",
  ...
  levels: [
    { level: 1, requiredLevel: 36, spCost: 26000, mpCost: 0, power: 1 },
  ],
};
