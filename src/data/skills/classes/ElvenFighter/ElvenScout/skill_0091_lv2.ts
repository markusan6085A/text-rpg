...
export const skill_0091_lv2: SkillDefinition = {
  id: 91,
  code: "ES_0091",
  name: "Defense Aura",
  description: "Temporarily increases P. Def. Effect 2.\n\nВременно увеличивает физическую защиту на 12% на 20 мин.",
  ...
  levels: [
    { level: 2, requiredLevel: 20, spCost: 2800, mpCost: 20, power: 0 },
  ],
};
