...
export const skill_0077_lv2: SkillDefinition = {
  id: 77,
  code: "ES_0077",
  name: "Attack Aura",
  description: "Temporarily increases P. Atk. Effect 2.\n\nВременно увеличивает физическую атаку на 12% на 20 мин.",
  ...
  levels: [
    { level: 2, requiredLevel: 28, spCost: 9200, mpCost: 25, power: 0 },
  ],
};
