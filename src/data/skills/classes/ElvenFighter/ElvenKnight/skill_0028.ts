...
// Aggression - provokes opponent to attack
export const skill_0028: SkillDefinition = {
  id: 28,
  code: "EK_0028",
  name: "Aggression",
  description: "Provokes an opponent to attack. Power 655.\n\nПровоцирует противника на атаку.",
  ...
  levels: [
    ...
    { level: 4, requiredLevel: 28, spCost: 5000, mpCost: 23, power: 752 },
    { level: 5, requiredLevel: 28, spCost: 5000, mpCost: 24, power: 777 },
    { level: 6, requiredLevel: 28, spCost: 5000, mpCost: 25, power: 803 },
