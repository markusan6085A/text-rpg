...
export const skill_0153: SkillDefinition = {
  ...
  code: "EK_0153",
  name: "Shield Mastery",
  description: "Shield defense increases. Increases shield block chance when shield is equipped.\n\nУвеличивает защиту щита. Увеличивает шанс блока щитом на 50% (уровень 1) и 70% (уровень 2) при экипировке щита.",
  ...
  scope: "single",
  effects: [
    { stat: "shieldBlockRate", mode: "flat" }, // Value from level.power (50% and 70%)
  ],
  levels: [
    { level: 1, requiredLevel: 20, spCost: 4100, mpCost: 0, power: 50 },
    { level: 2, requiredLevel: 28, spCost: 15000, mpCost: 0, power: 70 },
  ],
};
