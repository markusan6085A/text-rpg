...
export const skill_0231: SkillDefinition = {
  ...
  levels: [
    ...
    { level: 7, requiredLevel: 28, spCost: 4400, mpCost: 0, power: 30 },
    { level: 8, requiredLevel: 28, spCost: 4400, mpCost: 0, power: 31.8 },
    { level: 9, requiredLevel: 28, spCost: 4400, mpCost: 0, power: 33.6 },
    { level: 10, requiredLevel: 32, spCost: 7400, mpCost: 0, power: 37.4 },
    { level: 11, requiredLevel: 32, spCost: 7400, mpCost: 0, power: 39.3 },
    { level: 12, requiredLevel: 32, spCost: 7400, mpCost: 0, power: 41.3 },
    { level: 13, requiredLevel: 36, spCost: 9000, mpCost: 0, power: 45.6 },
    { level: 14, requiredLevel: 36, spCost: 9000, mpCost: 0, power: 47.7 },
    { level: 15, requiredLevel: 36, spCost: 9000, mpCost: 0, power: 50 },
  ],
};
