...
export const skill_0110: SkillDefinition = {
  ...
  description: "Instantly increases P. Def. and M. Def. significantly. User must remain still while it is in effect. Power 1.\n\nМгновенно значительно увеличивает физическую и магическую защиту. Пользователь должен оставаться неподвижным во время действия. Сила 1.",
  ...
  levels: [
    { level: 1, requiredLevel: 20, spCost: 4700, mpCost: 19, power: 1 },
  ],
};
