...
export const Skill_0016: SkillDefinition = {
  ...
  levels: [
    ...
    { level: 7, requiredLevel: 15, spCost: 950, mpCost: 16, power: 178 },
    { level: 8, requiredLevel: 15, spCost: 950, mpCost: 16, power: 193 },
    { level: 9, requiredLevel: 15, spCost: 950, mpCost: 17, power: 210 },
  ],
};
