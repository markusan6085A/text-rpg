...
export const Skill_0003: SkillDefinition = {
  ...
  levels: [
    ...
    { level: 7, requiredLevel: 15, spCost: 950, mpCost: 17, power: 60 },
    { level: 8, requiredLevel: 15, spCost: 950, mpCost: 18, power: 65 },
    { level: 9, requiredLevel: 15, spCost: 950, mpCost: 19, power: 70 },
  ],
};
