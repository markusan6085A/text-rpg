...
export const skill_0101: SkillDefinition = {
  ...
  levels: [
    { level: 1, requiredLevel: 36, spCost: 7400, mpCost: 69, power: 287 },
    { level: 2, requiredLevel: 36, spCost: 7400, mpCost: 72, power: 306 },
    { level: 3, requiredLevel: 36, spCost: 7400, mpCost: 74, power: 326 },
  ],
};
