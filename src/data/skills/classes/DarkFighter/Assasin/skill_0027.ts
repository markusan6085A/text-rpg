...
export const skill_0027: SkillDefinition = {
  ...
  levels: [
    ...
    { level: 3, requiredLevel: 28, spCost: 8500, mpCost: 25, power: 75 }, // 75% chance, 3 keys
    { level: 4, requiredLevel: 32, spCost: 14000, mpCost: 28, power: 100 }, // 100% lv1, 5% lv2, 3 keys
    { level: 5, requiredLevel: 36, spCost: 22000, mpCost: 31, power: 100 }, // 100% lv1, 30% lv2, 4 keys
  ],
};
