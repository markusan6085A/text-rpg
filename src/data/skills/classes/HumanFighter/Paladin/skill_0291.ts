...
// Final Fortress для Paladin (рівні 1-11)
export const skill_0291: SkillDefinition = {
  id: 291,
  code: "PAL_0291",
  name: "Final Fortress",
  description: "Automatically increases P. Def. when HP level falls.\n\nАвтоматически увеличивает физ. защиту на 116.9-215.8 (зависит от уровня), когда HP падает ниже 30%. Пассивный навык.",
  category: "passive",
  powerType: "none",
  target: "self",
  scope: "single",
  ...
  hpThreshold: 0.2,
  effects: [
    { stat: "pDef", mode: "flat", value: 116.875 },
  ],
  levels: [
