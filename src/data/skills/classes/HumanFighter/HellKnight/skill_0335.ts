...
// Fortitude для HellKnight (рівень 1)
export const skill_0335: SkillDefinition = {
  id: 335,
  code: "HKN_0335",
  name: "Fortitude",
  description: "Increases resistance to Shock/Paralysis attacks significantly. Continuously consumes MP.\n\nЗначительно увеличивает сопротивление к шоку и параличу на 30%. Непрерывно потребляет MP (35 MP каждые 3 сек). Переключаемый навык.",
  category: "toggle",
  powerType: "none",
  target: "self",
  scope: "single",
