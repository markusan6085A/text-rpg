...
// Battle Heal (levels 4-15 for Shillien Oracle)
export const skill_1015: SkillDefinition = {
  id: 1015,
  code: "DMO_1015",
  name: "Battle Heal",
  description: "Quickly recovers HP. Dark Elf Oracle progression (20-35).\n\nБыстро восстанавливает HP. Прогрессия Темного Эльфа Оракула (20-35).",
