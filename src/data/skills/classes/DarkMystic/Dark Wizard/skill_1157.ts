...
const mpGainValues = [22.0, 35.0, 47.0, 53.0, 61.0]; // power in XML is mp gain
...
export const skill_1157: SkillDefinition = {
  ...
  castTime: 4,
  cooldown: 20,
  levels: mpGainValues.map((mpGain, index) => ({
    level: index + 1,
    requiredLevel: index < 1 ? 25 : index < 2 ? 35 : index < 3 ? 45 : index < 4 ? 55 : 65,
    spCost: index < 1 ? 5800 : index < 2 ? 15000 : index < 3 ? 30000 : index < 4 ? 60000 : 120000,
    mpCost: 0, // MP cost is 0, HP is consumed
    power: mpGain, // Store MP gain in power
    hpConsume: hpConsumeValues[index], // Store HP consume here
  })),
};
