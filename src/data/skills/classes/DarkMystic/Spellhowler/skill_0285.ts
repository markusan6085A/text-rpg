...
export const skill_0285: SkillDefinition = {
  ...
  levels: gainMpValues.map((gain, index) => ({
    ...
    spCost: index < 2 ? 1400 : index < 4 ? 2800 : index < 6 ? 5300 : index < 8 ? 8800 : index < 10 ? 15000 : index < 12 ? 30000 : index < 14 ? 50000 : index < 16 ? 80000 : index < 18 ? 120000 : index < 20 ? 160000 : index < 22 ? 200000 : index < 24 ? 300000 : index < 26 ? 500000 : 800000,
    mpCost: 0,
    power: gain,
  })),
};
