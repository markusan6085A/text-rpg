...
// Fast HP Recovery - increases HP recovery speed (continuation from Artisan)
...
export const skill_0212: SkillDefinition = {
  ...
  levels: [
    ...
    { level: 5, requiredLevel: 52, spCost: 170000, mpCost: 0, power: 2.6 },
    { level: 6, requiredLevel: 58, spCost: 270000, mpCost: 0, power: 2.7 },
