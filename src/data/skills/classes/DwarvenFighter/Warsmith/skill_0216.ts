...
// Polearm Mastery - increases P. Atk when using polearm (continuation from Artisan)
...
// #atkCountMax: 10 for all levels, accuracy: 10 for all levels
export const skill_0216: SkillDefinition = {
  ...
  effects: [
    ...
    { stat: "accuracy", mode: "flat", value: 10 }, // From description
  ],
  levels: [
    ...
    { level: 21, requiredLevel: 52, spCost: 56000, mpCost: 0, power: 49.2 },
    { level: 22, requiredLevel: 52, spCost: 56000, mpCost: 0, power: 51.9 },
    { level: 23, requiredLevel: 52, spCost: 56000, mpCost: 0, power: 54.6 },
    ...
    { level: 27, requiredLevel: 58, spCost: 89000, mpCost: 0, power: 66.4 },
    { level: 28, requiredLevel: 58, spCost: 89000, mpCost: 0, power: 69.5 },
    { level: 29, requiredLevel: 58, spCost: 89000, mpCost: 0, power: 72.7 },
    { level: 30, requiredLevel: 60, spCost: 180000, mpCost: 0, power: 76 },
    { level: 31, requiredLevel: 60, spCost: 180000, mpCost: 0, power: 79.3 },
