...
// Stun Attack - stunning blow with blunt weapon
// XML: mpConsume: 20-37, power: 30-109, hitTime: 1080, reuseDelay: 13000
export const skill_0100: SkillDefinition = {
  ...
  cooldown: 13,
  levels: [
    { level: 1, requiredLevel: 20, spCost: 1200, mpCost: 22, power: 30 },
    { level: 2, requiredLevel: 20, spCost: 1200, mpCost: 22, power: 33 },
    { level: 3, requiredLevel: 20, spCost: 1200, mpCost: 22, power: 35 },
    { level: 4, requiredLevel: 24, spCost: 2300, mpCost: 23, power: 41 },
    { level: 5, requiredLevel: 24, spCost: 2300, mpCost: 24, power: 44 },
    { level: 6, requiredLevel: 24, spCost: 2300, mpCost: 25, power: 48 },
