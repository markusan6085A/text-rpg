...
export const skill_0227: SkillDefinition = {
  ...
  effects: [
    ...
    { stat: "evasion", mode: "flat" }, // Value varies by level
  ],
  levels: [
    { level: 1, requiredLevel: 20, spCost: 1900, mpCost: 0, power: 4.2 }, // evasion: 3
    { level: 2, requiredLevel: 20, spCost: 1900, mpCost: 0, power: 5.3 }, // evasion: 3
    { level: 3, requiredLevel: 24, spCost: 3500, mpCost: 0, power: 6.5 }, // evasion: 5
    { level: 4, requiredLevel: 24, spCost: 3500, mpCost: 0, power: 7.7 }, // evasion: 5
