...
export const skill_0231: SkillDefinition = {
  ...
  levels: [
    { level: 1, requiredLevel: 20, spCost: 2100, mpCost: 0, power: 1.9 },
    { level: 2, requiredLevel: 20, spCost: 2100, mpCost: 0, power: 3.3 },
    { level: 3, requiredLevel: 24, spCost: 3900, mpCost: 0, power: 4.8 },
    { level: 4, requiredLevel: 24, spCost: 3900, mpCost: 0, power: 6.4 },
