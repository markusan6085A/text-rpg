...
export const skill_1069: SkillDefinition = {
  ...
  levels: [
    { level: 1, requiredLevel: 25, spCost: 2000, mpCost: 22, power: 0 },
    { level: 2, requiredLevel: 25, spCost: 2000, mpCost: 22, power: 0 },
    { level: 3, requiredLevel: 25, spCost: 2000, mpCost: 23, power: 0 },
    { level: 4, requiredLevel: 30, spCost: 3900, mpCost: 25, power: 0 },
    { level: 5, requiredLevel: 30, spCost: 3900, mpCost: 27, power: 0 },
    { level: 6, requiredLevel: 30, spCost: 3900, mpCost: 27, power: 0 },
