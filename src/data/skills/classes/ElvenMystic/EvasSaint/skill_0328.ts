...
export const skill_0328: SkillDefinition = {
  ...
  code: "ES_0328",
  name: "Wisdom",
  description: "Increases resistance to Hold, Sleep, and Mental attacks.\n\nВременно увеличивает сопротивление к удержанию на 20%.\nВременно увеличивает сопротивление ко сну на 20%.\nВременно увеличивает сопротивление к ментальным атакам (дебаффы, проклятия) на 20%.",
