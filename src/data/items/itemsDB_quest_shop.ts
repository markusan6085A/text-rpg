...
export const itemsDBQuestShop: Record<string, ItemDefinition> = {
  ...
  ring_of_core: {
    ...
    description:
      "Трофей з нетрів Гармої: темний метал, наче спечений у розпеченому ядрі голема. Міцний магічний оберіг (M.Def +48), точніший удар (+2 Accuracy), стійкість і шанс отрути по 20%, коріння — по 30%, і витіснення частини вхідної шкоди (~10%). Два такі кільця не подвоюють бонуси — враховується лише одне.",
    grade: "C",
    stackable: false,
    stats: {
      mDef: 48,
  ...
  /** Епік-дроп Zaken (6659). Друга сережка не дублює пасиви — як Earring of Orfen. */
  earring_of_zaken: {
    id: "earring_of_zaken",
    ...
    description:
      "Трофей з Дзеркального лісу. M.Def +71, Max MP +31. Додатково: краще відхилення кровотечі (−40% вразливості), +10% до отриманого зцілення, поглинання частини урону (−4% вхідної шкоди), стійкість до оглушення/шоку (+40%), до ментальних ефектів (+40%). Друга така сережка не подвоює бонуси.",
    grade: "A",
    stackable: false,
    stats: {
      mDef: 71,
  ...
  ring_of_baium: {
    ...
    description:
      "Перстень імператора з Кеміуму. M.Def +48, Max MP +21. Додатково: сильніший опір отруті (+80%), +2 Accuracy, ~+15% сили криту, опір утриманню та root (+60%), +4% швидкості фізичної атаки та касту.",
    grade: "S",
    stackable: false,
    stats: {
      mDef: 48,
  ...
  necklace_of_valakas: {
    ...
    description:
      "Камінь червоного дракона. M.Def +95, Max MP +42, +445 Max HP. Додатково: +4% фізичної атаки, +8% магічної атаки, помітний бонус до магічного криту та сили магічних скілів, легкий опір сну та вогню.",
    grade: "S",
    stackable: false,
    stats: {
      mDef: 95,
  ...
  earring_of_antharas: {
    ...
    description:
      "Трофей земляного дракона. M.Def +71, Max MP +31. Додатково: опір кровотечі (+80%), +10% отриманого зцілення, поглинання (−4% вхідної шкоди), опір оглушенню, шоку та ментальним ефектам (+60%), −5% витрат MP на скіли, легкий опір землі.",
    grade: "S",
    stackable: false,
    stats: {
      mDef: 71,
