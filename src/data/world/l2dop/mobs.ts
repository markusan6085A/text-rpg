...
export const L2DOP_MOB_20001: Mob = {
  ...
  adenaMin: 6, adenaMax: 12, dropChance: 0.7, drops: [drop("thread", "resource", 0.02, 1, 1)], spoil: [drop("thread", "resource", 0.02, 1, 1)],
};
export const L2DOP_MOB_20002: Mob = {
  id: "l2dop_20002", name: "Кролик", level: 1, hp: 40, mp: 40, pAtk: 8, mAtk: 6, pDef: 44, mDef: 30, exp: 29, sp: 2,
  adenaMin: 6, adenaMax: 12, dropChance: 0.7, drops: [drop("animal_bone", "resource", 0.01, 1, 1)], spoil: [drop("animal_bone", "resource", 0.01, 1, 1)],
};
export const L2DOP_MOB_20003: Mob = {
  ...
  adenaMin: 30, adenaMax: 42, dropChance: 0.7, drops: [drop("stem", "resource", 0.02, 1, 1), drop("varnish", "resource", 0.01, 1, 1)], spoil: [drop("stem", "resource", 0.02, 1, 1)],
};
export const L2DOP_MOB_20004: Mob = {
  id: "l2dop_20004", name: "Бес", level: 6, hp: 94, mp: 77, pAtk: 14, mAtk: 9, pDef: 54, mDef: 36, exp: 213, sp: 6,
  adenaMin: 41, adenaMax: 58, dropChance: 0.7, drops: [drop("suede", "resource", 0.05, 1, 1), drop("charcoal", "resource", 0.015, 1, 1)], spoil: [drop("suede", "resource", 0.05, 1, 1)],
};
export const L2DOP_MOB_20005: Mob = {
  ...
  adenaMin: 51, adenaMax: 72, dropChance: 0.7, drops: [drop("varnish", "resource", 0.014, 1, 1), drop("coal", "resource", 0.014, 1, 1)], spoil: [drop("suede", "resource", 0.065, 1, 1)],
};
export const L2DOP_MOB_20006: Mob = {
  ...
  adenaMin: 69, adenaMax: 94, dropChance: 0.7, drops: [drop("suede", "resource", 0.017, 1, 1), drop("charcoal", "resource", 0.025, 1, 1)], spoil: [drop("suede", "resource", 0.028, 1, 1)],
};
export const L2DOP_MOB_20007: Mob = {
  ...
  adenaMin: 80, adenaMax: 108, dropChance: 0.7, drops: [drop("stem", "resource", 0.06, 1, 1), drop("iron_ore", "resource", 0.03, 1, 1)], spoil: [drop("stem", "resource", 0.06, 1, 1)],
};
export const L2DOP_MOB_20091: Mob = {
  ...
  adenaMin: 6, adenaMax: 12, dropChance: 0.7, drops: [drop("animal_bone", "resource", 0.015, 1, 1)], spoil: [drop("animal_bone", "resource", 0.015, 1, 1)],
};
export const L2DOP_MOB_20092: Mob = {
  ...
  adenaMin: 95, adenaMax: 125, dropChance: 0.7, drops: [drop("stem", "resource", 0.05, 1, 1), drop("varnish", "resource", 0.03, 1, 1)], spoil: [drop("stem", "resource", 0.05, 1, 1)],
};
export const L2DOP_MOB_20093: Mob = {
  ...
  adenaMin: 100, adenaMax: 130, dropChance: 0.7, drops: [drop("iron_ore", "resource", 0.04, 1, 1), drop("animal_bone", "resource", 0.03, 1, 1)], spoil: [drop("iron_ore", "resource", 0.04, 1, 1)],
};
export const L2DOP_MOB_20094: Mob = {
  ...
  adenaMin: 98, adenaMax: 128, dropChance: 0.7, drops: [drop("stem", "resource", 0.04, 1, 1), drop("coal", "resource", 0.025, 1, 1)], spoil: [drop("stem", "resource", 0.04, 1, 1)],
};
export const L2DOP_MOB_20095: Mob = {
  ...
  adenaMin: 92, adenaMax: 122, dropChance: 0.7, drops: [drop("animal_bone", "resource", 0.045, 1, 1), drop("stem", "resource", 0.035, 1, 1)], spoil: [drop("animal_bone", "resource", 0.045, 1, 1)],
};
export const L2DOP_MOB_20096: Mob = {
  ...
  adenaMin: 110, adenaMax: 145, dropChance: 0.7, drops: [drop("iron_ore", "resource", 0.045, 1, 1), drop("coal", "resource", 0.03, 1, 1)], spoil: [drop("iron_ore", "resource", 0.045, 1, 1)],
};
export const L2DOP_MOB_20099: Mob = {
  ...
  adenaMin: 125, adenaMax: 165, dropChance: 0.7, drops: [drop("animal_bone", "resource", 0.06, 1, 1), drop("coarse_bone_powder", "resource", 0.02, 1, 1)], spoil: [drop("animal_bone", "resource", 0.06, 1, 1)],
};
export const L2DOP_MOB_20100: Mob = {
  ...
  adenaMin: 140, adenaMax: 185, dropChance: 0.7, drops: [drop("animal_bone", "resource", 0.055, 1, 1), drop("iron_ore", "resource", 0.035, 1, 1)], spoil: [drop("animal_bone", "resource", 0.055, 1, 1)],
};
export const L2DOP_MOB_20021: Mob = {
  ...
  adenaMin: 155, adenaMax: 205, dropChance: 0.7, drops: [drop("suede", "resource", 0.05, 1, 1), drop("animal_bone", "resource", 0.04, 1, 1)], spoil: [drop("suede", "resource", 0.05, 1, 1)],
};
export const L2DOP_MOB_20030: Mob = {
  ...
  adenaMin: 170, adenaMax: 225, dropChance: 0.7, drops: [drop("leather", "resource", 0.03, 1, 1), drop("animal_bone", "resource", 0.045, 1, 1)], spoil: [drop("leather", "resource", 0.03, 1, 1)],
};
export const L2DOP_MOB_20035: Mob = {
  ...
  adenaMin: 200, adenaMax: 265, dropChance: 0.7, drops: [drop("coarse_bone_powder", "resource", 0.04, 1, 1), drop("animal_bone", "resource", 0.06, 1, 1)], spoil: [drop("coarse_bone_powder", "resource", 0.04, 1, 1)],
};
export const L2DOP_MOB_20008: Mob = {
  ...
  adenaMin: 150, adenaMax: 200, dropChance: 0.7, drops: [drop("varnish", "resource", 0.044, 1, 1), drop("thread", "resource", 0.03, 1, 1)], spoil: [drop("varnish", "resource", 0.044, 1, 1)],
};
export const L2DOP_MOB_20069: Mob = {
  ...
  adenaMin: 320, adenaMax: 420, dropChance: 0.7, drops: [drop("mithril_ore", "resource", 0.02, 1, 1), drop("steel", "resource", 0.015, 1, 1)], spoil: [drop("mithril_ore", "resource", 0.02, 1, 1)],
};
export const L2DOP_MOB_20083: Mob = {
  ...
  adenaMin: 380, adenaMax: 510, dropChance: 0.7, drops: [drop("mithril_ore", "resource", 0.025, 1, 1), drop("steel", "resource", 0.02, 1, 1)], spoil: [drop("mithril_ore", "resource", 0.025, 1, 1)],
};
