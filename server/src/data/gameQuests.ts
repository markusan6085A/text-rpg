// SYNC: копія `src/data/quests.ts` — при зміні квестів оновити обидва файли (або скрипт копіювання).
// Сервер використовує для валідації здачі квестів.
...
export const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    resourceCraftHint:
      "Steel: крафт ресурсов с 20 ур. — 5 Varnish + 5 Iron Ore → 1 Steel (город → Крафт ресурсов).",
    description:
      "Странник теней в Gludio поручает испытание: убейте 100 обычных мобов (не рейд-босов), чей уровень отличается от вашего не более чем на 2. Принесите 10 Steel (с 20 ур. скрафтите в городе или добудьте тиерный дроп с мобов ~21+). " +
    ...
    questDrops: [
      {
        mobName: "Steel (крафт или типичный дроп 21+)",
        itemId: "steel",
        requiredCount: 10,
        farmHint:
          "Основной способ: с 20 ур. «Крафт ресурсов» в городе — 5 Varnish + 5 Iron Ore → 1 Steel. Дополнительно может выпасть тиерный ресурсный дроп с мобов примерно 21+ ур.",
      },
    ],
  },
  {
